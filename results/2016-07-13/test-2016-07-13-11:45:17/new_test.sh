...
python3 ${script_dir_path}/../../src/rnn_simple.py --max_epoch 800 --hidden_size 1 --batch_size 1 --output_size 2 --seq_len 5 --data_size 4000 --rseed 0  --loss_diff_eps 1e-7 --grad_clip False --max_grad_norm 5 --train_method "single" --lr_test False
