...
filename="Test-`date \"+%F-%T"`" # will output something like 2016-03-13-17:35:11
...
python3 ${script_dir_path}/../../src/rnn_simple_sigm_data.py --max_epoch 100 --hidden_size 50 --batch_size 1 --output_size 1 --seq_len 13 --data_size 4000 --rseed 0  --loss_diff_eps 1e-6 --grad_clip True --max_grad_norm 1 --train_method "total" --lr_test True --cell_type "lstm" --learning_rate 0.001
