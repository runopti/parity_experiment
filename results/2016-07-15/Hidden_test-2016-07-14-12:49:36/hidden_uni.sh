...
python3 ${script_dir_path}/../../src/rnn_simple.py --max_epoch 800 --hidden_size 20 --batch_size 1 --output_size 2 --seq_len 15 --data_size 4000 --rseed 0  --loss_diff_eps 1e-9 --grad_clip True --max_grad_norm 10 --train_method "single" --lr_test True --cell_type "lstm" --learning_rate 0.01
