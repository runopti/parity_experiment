...
python3 ${script_dir_path}/../../src/rnn_simple_sigm.py --max_epoch 500 --hidden_size 5 --batch_size 1 --output_size 1 --seq_len 13 --data_size 4000 --rseed 0  --loss_diff_eps 1e-8 --grad_clip True --max_grad_norm 5 --train_method "single" --lr_test True --cell_type "lstm" --learning_rate 0.001
