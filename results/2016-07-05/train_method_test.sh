...
python3 ${script_dir_path}/../../src/rnn_test_classif_graph.py --max_epoch 800 --hidden_size 1 --batch_size 1 --output_size 2 --seq_len 3 --data_size 1000 --rseed 0 --loss_diff_eps 1e-7 --grad_clip True --max_grad_norm 5 --train_method "single"
