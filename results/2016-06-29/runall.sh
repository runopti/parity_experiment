#!/bin/sh
## baseline 
filename="baseline-`date \"+%F-%T"`" # will output something like 2016-03-13-17:35:11
...
python ${script_dir_path}/../../src/rnn_test_classif_graph.py --max_epoch 3 --hidden_size 2 --batch_size 1 --output_size 2 --seq_len 3 --data_size 1000
...
python ${script_dir_path}/../../src/plot_table.py --num_plot 2 --save img --max_epoch 3 --yaxis acc_list.pickle total_loss_list.pickle --xaxis 3 3
