...
python3 ${script_dir_path}/../../src/rnn_test_classif_graph.py --max_epoch 300 --hidden_size 1 --batch_size 1 --output_size 2 --seq_len 3  --data_size 1000 --rseed 0
...
python3 ${script_dir_path}/../../src/rnn_test_classif_graph.py --max_epoch 300 --hidden_size 1 --batch_size 1 --output_size 2 --seq_len 4 --data_size 1000 --rseed 0
# passing the right path to train_mnist.lua using ${script_dir_path} which is the current directory where 
# this runall.sh is located.
...
python3 ${script_dir_path}/../../src/rnn_test_classif_graph.py --max_epoch 300 --hidden_size 1 --batch_size 1 --output_size 2 --seq_len 5 --data_size 1000 --rseed 0
# passing the right path to train_mnist.lua using ${script_dir_path} which is the current directory where 
# this runall.sh is located.
...
python3 ${script_dir_path}/../../src/rnn_test_classif_graph.py --max_epoch 300 --hidden_size 1 --batch_size 1 --output_size 2 --seq_len 6 --data_size 1000 --rseed 0
# passing the right path to train_mnist.lua using ${script_dir_path} which is the current directory where 
# this runall.sh is located.
