...
#python3 ${script_dir_path}/../../src/test.py --max_epoch 2 --hidden_size 1 --batch_size 1 --output_size 2 --seq_len 4  --data_size 1000 --rseed 0
python3 ${script_dir_path}/../../src/rnn_test_classif_graph.py --max_epoch 2 --hidden_size 1 --batch_size 1 --output_size 2 --seq_len 4  --data_size 1000 --rseed 0
...
python3 ${script_dir_path}/../../src/plot_table.py --num_plot 2 --save img --max_epoch 2 --yaxis acc_list.pickle total_loss_list.pickle --xaxis 2 2 
